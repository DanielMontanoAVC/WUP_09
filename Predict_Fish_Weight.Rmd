...
The best model for perch prediction was Height + Width, for pike it was Length1 + Length3, and for roach was Length3 + Width.
The best adjusted R-squares for each is, in descending order; Pike with 